...
namespace Grok3d { namespace Components 
{
    ...
    class GRK_GameLogicComponent
    {
        ...
        protected:
            ...
            notstd::unordered_bidir_map<BehaviourHandle, BehaviourIndex> m_behaviourIndexMap; ///< an internal bidirectional mapping of handles to indexes into m_behaviours
            std::vector<std::unique_ptr<GRK_GameBehaviourBase>> m_behaviours; ///< the actual store of behaviours, stored as unique_ptr for lifetime management
