...
//TODO 8 that determines initial entity allocation size, here it is 1024
template<class ComponentType>
GRK_ComponentManager<ComponentType>::GRK_ComponentManager()
{
    m_entityMap = new std::unordered_map<ComponentType>(1024);
    m_components = new std::vector<ComponentType>(1024);
}
...
GRK_Result GRK_ComponentManager<ComponentType>::AddComponent(GRK_Entity entity, ComponentType& component)
{
    ...
    {
        //set this as componentmanager for the child class
